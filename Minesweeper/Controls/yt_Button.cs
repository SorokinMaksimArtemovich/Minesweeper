...
namespace yt_DesignUI
{
    public class yt_Button : Control
    {
        ...
        [Description("Цвет эффекта \"шторки\" по наведению курсора на кнопку")]
        public Color HideColor { get; set; } = Color.White;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graph.DrawRectangle(new Pen(Color.FromArgb(60, HideColor)), rectCurtain);
            graph.FillRectangle(new SolidBrush(Color.FromArgb(60, HideColor)), rectCurtain);
            ...
            if (UseRippleEffect == false)
            {
                ...
                if (MousePressed)
                {
                    graph.DrawRectangle(new Pen(Color.FromArgb(30, Color.WhiteSmoke)), rect);
                    graph.FillRectangle(new SolidBrush(Color.FromArgb(30, Color.WhiteSmoke)), rect);
                }
            }
            else
            {
