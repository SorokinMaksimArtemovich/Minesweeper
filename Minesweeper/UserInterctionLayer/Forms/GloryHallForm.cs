...
{
    public partial class GloryHallForm : WindowForm
    {
        public GloryHallForm()
        {
            InitializeComponent();
        }
        private void GloryHallForm_SizeChanged(object sender, EventArgs e)
        {
            ...
            yt_Button1.Location = new Point((int)(0.23 * Width), (int)(0.7827 * Height) + WindowFormStyle.HeaderHeight);
            yt_Button2.Location = new Point((int)(0.356 * Width), (int)(0.7827 * Height) + WindowFormStyle.HeaderHeight);
            yt_Button3.Location = new Point((int)(0.545 * Width), (int)(0.7827 * Height) + WindowFormStyle.HeaderHeight);
